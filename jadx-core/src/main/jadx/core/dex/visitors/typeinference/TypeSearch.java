...
public class TypeSearch {
	...
	public boolean run() {
        ...
        for (TypeSearchVarInfo varInfo : state.getUnresolvedVars()) {
    ...
    boolean allRelatedVarsResolved = true;
    for (ITypeConstraint c : varInfo.getConstraints()) {
        for (SSAVar ssaVar : c.getRelatedVars()) {
            TypeSearchVarInfo relatedVarInfo = state.getVarInfo(ssaVar); // Rename the variable here
            if (!relatedVarInfo.isTypeResolved()) {
