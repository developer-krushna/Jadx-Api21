...
public class AnnotatedCodeWriter extends SimpleCodeWriter implements ICodeWriter {
    ...
    if (!annotations.isEmpty()) {
        for (Map.Entry<Integer, ICodeAnnotation> entry : annotations.entrySet()) {
            ...
            ICodeAnnotation v = entry.getValue();
...
private void validateAnnotations() {
    ...
    Iterator<Map.Entry<Integer, ICodeAnnotation>> iterator = annotations.entrySet().iterator();
    while (iterator.hasNext()) {
        Map.Entry<Integer, ICodeAnnotation> entry = iterator.next();
