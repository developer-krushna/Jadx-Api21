...
public final class JavaMethod implements JavaNode {
	...
	public List<ArgType> getArguments() {
		...
		List<ArgType> resolvedArguments = new ArrayList<>();
		
		for (ArgType type : arguments) {
			resolvedArguments.add(ArgType.tryToResolveClassAlias(mth.root(), type));
		}
	...
	public List<JavaMethod> getOverrideRelatedMethods() {
		...
		for (MethodNode m : ovrdAttr.getRelatedMthNodes()) {
